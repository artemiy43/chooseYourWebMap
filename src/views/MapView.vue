<template>
  <main class="main">
    ...
    <ul class="main--container">
      ...
      <li class="main--map_quality">
        Лицензия: <span class="main--map_quality_value">{{ map.licence }}</span>
      </li>
      <li class="main--map_quality">
        Представления карт:
      ...
      <li class="main--map_quality">
        Наличие поддержки от разработчиков библиотеки для ответов на вопросы или
        наличие открытого форума для общения и передачи опыта работы с
        технологией:
        <span class="main--map_quality_value">
